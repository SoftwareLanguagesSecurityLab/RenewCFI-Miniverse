...
void load_miniverse_simple(){
  ...
  register_handler = (void(*)(bool(*)(uintptr_t,uint8_t*,uintptr_t,size_t)))0xdeae52d2;
...
int main(int argc, char** argv){
  ...
  wrap_mmap = (void(*)(void*,size_t,int,int,int,off_t))0xdeae53a9;

  /* Set pointer to wrap_mprotect function */
  void (*wrap_mprotect)(void*,size_t,int);
  wrap_mprotect = (void(*)(void*,size_t,int))0xdeae547f;
