...
void load_miniverse_simple(){
  ...
  uint8_t *mini_exec = mmap((void*)0xdeadb000, 0xa0beb, PROT_READ|PROT_EXEC,
                            MAP_PRIVATE,fd,0);
  ...
  memset((void*)0xdeb8ce98, 0, 0x4168);
  ...
  register_handler = (void(*)(bool(*)(uintptr_t,uint8_t*,uintptr_t,size_t)))0xdeae529f;
...
int main(int argc, char** argv){
  ...
  wrap_mmap = (void(*)(void*,size_t,int,int,int,off_t))0xdeae5376;

  /* Set pointer to wrap_mprotect function */
  void (*wrap_mprotect)(void*,size_t,int);
  wrap_mprotect = (void(*)(void*,size_t,int))0xdeae544c;
